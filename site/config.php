...
$config->dbName = 'electug8_processwire1';
$config->dbUser = 'electug8_pwire1';
$config->dbPass = 'cerveza-gx1';
$config->dbPort = '3306';
 ...
 * 
 */
$config->userAuthSalt = '6a5ba4d6ffae61711921190db9600fab'; 
 ...
 * 
 */
//$config->httpHosts = array('pwtest.electrobach.com');
$config->httpHosts = array('pwtest.local');
